...
const Schedule = () => {
    ...
    piketGroup = [
        ["Adam", "Asti", "Aulia", "Fanny", "Izham", "Azzam", "Yuda", "hanif"],
        ["Adita", "Aunna", "Hasby", "Lutfiana", "Faaza", "Nahira", "Jaliesvio"],
        ["Akmal", "Alya", "Vippy", "Yusuf", "Hanan", "Nailah", "Ellen"],
        ["Amira", "Fadillah", "Mutia", "Radinka", "Nazwa", "Damara", "Rasyah"],
        ["Mario", "Ridho", "Rishelin", "Rizki", "Safira", "Syfha", "Wahid"],
    ]
