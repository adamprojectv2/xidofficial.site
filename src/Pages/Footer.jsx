					...
					<div class="grid grid-cols-2 sm:grid-cols-3">
						<div className=" ">
							...
							<ul class="text-gray-400 dark:text-gray-400 font-medium">
								<li class="mb-2">
									<a href="https://www.instagram.com/damzzz_54/?hl=id" class="hover:underline">
										DAMZ
									</a>
								</li>
								<li>
									<a href="https://www.instagram.com/h4you_01/?hl=id" class="hover:underline">
										HASBY
									</a>
								</li>
							</ul>
						...
						<div className="">
							...
							<ul class="text-gray-400 dark:text-gray-400 font-medium">
								<li class="mb-2">
									<a href="https://www.instagram.com/heyy.sydandi_/?hl=id" class="hover:underline ">
										Instagram
									</a>
								</li>
								<li>
									<a href="https://www.tiktok.com/@smntr.sebelasde?_r=1&_t=ZS-95UdsMnC0fs" class="hover:underline">
										Tiktok
									</a>
								</li>
							</ul>
				...
				<div class="sm:flex sm:items-center sm:justify-between">
					<div class="flex mt-4 justify-center sm:mt-0">
						<p className="text-[0.7rem] text-white opacity-70">
							© {new Date().getFullYear()} Kelas XI.D | Di Kelola Oleh Siswa XI.D
						</p>
					</div>
				</div>
			</div>
