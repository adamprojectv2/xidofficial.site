	...
	return (
		<div className="z-1 relative h-auto lg:overflow-hidden">
			...
			<div data-aos="fade-up" data-aos-duration="500" className="mt-14 md:mt-10">
				<BorderStruktur Jabatan="Wali Kelas" Nama="Syahid Andi, S.pd" Width="150px" />
			</div>
			<div className="flex flex-col justify-center items-center">
				...
				<div className="flex relative top-[-3rem]" data-aos="fade-up" data-aos-duration="1200">
					<div className="relative left-[0.2rem]">
						<BorderStruktur Jabatan="Ketua Kelas" Nama="Ridoartha" Width="120px" />
					</div>
					...
					<div className="relative right-[0.2rem]">
						<BorderStruktur Jabatan="Wakil Ketua" Nama="Rizky Abdul" Width="120px" />
					</div>
				</div>
				...
				<div
					...
					<div className="flex-col">
						<BorderStruktur Jabatan="Sekertaris" Nama="Sarifatul Aulia" Width="120px" />
						<div className="py-[3%]"></div>
						<BorderStruktur Jabatan="" Nama="Asti Dwi" Width="120px" />
					</div>

					<div className="flex-col">
						<BorderStruktur Jabatan="Bendahara" Nama="Damara" Width="120px" />
						<div className="py-[3%]"></div>
						<BorderStruktur Jabatan="" Nama="Nazwa dwi" Width="120px" />
					</div>
				</div>
				...
				<div
					...
					<div className="flex-col">
						<BorderStruktur Jabatan="Keamanan" Nama="Adam Marvel" Width="120px" />
						<div className="py-[3%]"></div>
						<BorderStruktur Jabatan="" Nama="Hasby Shodikin" Width="120px" />
					</div>

					<div className="flex-col">
						<BorderStruktur Jabatan="Kebersihan" Nama="Izham hafidz" Width="120px" />
						<div className="py-[3%]"></div>
						<BorderStruktur Jabatan="" Nama="Wahid" Width="120px" />
					</div>

					<div className="flex-col hidden lg:flex">
						<BorderStruktur Jabatan="Kesehatan" Nama="Azhar Alya" Width="120px" />
						<div className="py-[3%]"></div>
						<BorderStruktur Jabatan="" Nama="Vippy septavia" Width="120px" />
					</div>
				</div>
				...
				<div
					...
					data-aos-duration="1100">
					<div className="flex-col">
						<BorderStruktur Jabatan="Kesehatan" Nama="Vippy Septavia" Width="120px" />
					</div>

					<div className="flex-col">
						<BorderStruktur Jabatan="Kesehatan" Nama="Sarifahtul Aulia" Width="120px" />
					</div>
				</div>
				...
				<div
					...
					data-aos-duration="1100">
					<div className="flex-col">
						<BorderStruktur Jabatan="Peralatan" Nama="Lutfiana Fauziah" Width="120px" />
					</div>

					<div className="flex-col">
						<BorderStruktur Jabatan="Peralatan" Nama="Wulan" Width="120px" />
					</div>
				</div>
				...
				<div className=" absolute bottom-[15%] lg:bottom-[20%] " data-aos="fade-up" data-aos-duration="1000">
					<div className="flex justify-center items-center flex-col">
						...
						<div className="relative bottom-3">
							<BorderStruktur Jabatan="Peralatan" Nama="Hasby" Width="120px" />
						</div>
					</div>
				</div>
				...
				{/* 	<div
					...
					<div className="flex justify-center items-center flex-col">
						...
						<img src="Circle.svg" alt="" className="relative top-[-0.7rem]" />
						<div className="relative bottom-3">
							<BorderStruktur Jabatan="Kesehatan" Nama="Vippy" Width="120px" />
							<div className="py-[3%]"></div>
							<BorderStruktur Jabatan="" Nama="Sarifahtul aulia" Width="120px" />
						</div>
					</div>
				</div> */}
			</div>
